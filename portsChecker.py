...
'''
#WORK#
r1 = threading.Thread(target=portCheck,args=("192.168.88.146",445))
r2 = threading.Thread(target=portCheck,args=("192.168.88.146",139))
r3 = threading.Thread(target=portCheck,args=("192.168.88.146",80))
r1.start()
r2.start()
r3.start()
'''
...
'''
r1 = threading.Thread(target=test)
r1.start()
counter = 0
while r1.is_alive():           # loop while the worker is still running
    print(f".", end=" ",flush=True) # prints 0,1,2,… once per second
    counter += 1
